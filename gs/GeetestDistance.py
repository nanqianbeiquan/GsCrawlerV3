...
if __name__ == '__main__':
    bg_path = os.path.join(os.path.dirname(__file__), '../temp/bg.jpg')  # 有缺口的背景图
    slice_path = os.path.join(os.path.dirname(__file__), '../temp/slice.jpg')  # 滑块
    fullbg_path = os.path.join(os.path.dirname(__file__), '../temp/fullbg.jpg')  # 完整的背景图
