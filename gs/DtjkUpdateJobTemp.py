...
class DtjkUpdateJobTemp(DtjkUpdateJob):
    ...
    def __init__(self):
        super(DtjkUpdateJobTemp, self).__init__()

    def set_config(self):
        self.searcher = GsCrawler()
        self.searcher.dst_topic = 'GSCrawlerResultTest'
        self.src_table = 'enterprise_credit_info.dtjk_company_src_temp'
        self.pk_name = 'mc'

if __name__ == '__main__':
    job = DtjkUpdateJobTemp()
    job.run()
