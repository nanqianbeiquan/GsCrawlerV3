...
class SiChuan(Searcher, GeetestBrokerOffline):
    ...
    def get_tag_a_from_page0(self, keyword):
        ...
        # self.get_request('http://sc.gsxt.gov.cn/notice/')
        ...
        # url_1 = "http://sc.gsxt.gov.cn/notice/security/verify_ip"
        # r_1 = self.post_request(url_1)
        # print r_1.text
        #
        # url_2 = "http://sc.gsxt.gov.cn/notice/security/verify_keyword"
        # params_2 = {
        #     'keyword': keyword
        # }
...
if __name__ == '__main__':
    ...
    searcher.submit_search_request(u'中国新型建筑材料公司成都公司第三经营部')  # 天顺橡胶化工有限公司')
    ...
    print json.dumps(searcher.json_result, ensure_ascii=False,sort_keys=True, indent=4, separators=(',', ': '))
