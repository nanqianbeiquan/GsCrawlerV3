/**
 * Created by likai on 17/9/10.
 */
(function(distance, challenge){
    B8RR.d2Z = function() {
        var r = 2;
        while (r !== 1) {
            switch (r) {
    ...
    var userresponse_imitator =function (d8C, Q1Y) {
        ...
        while (C8Z !== f2Z.V2Z()[20][22][46]) {
            switch (C8Z) {
                ...
                case f2Z.V2Z()[2][19][31]:
                    ...
                    B8C[U1Y] || (B8C[U1Y] = 1, l1Y[y1Y][f2Z.S3C(617)](U1Y), y1Y++, y1Y = 5 == y1Y ? 0 : y1Y);
                ...
                case f2Z.V2Z()[11][13][37]:
                    q8C - e8C[k1Y] >= 0 ? (s8C = parseInt(Math[f2Z.t3C(338)]() * l1Y[k1Y][f2Z.t3C(462)], 10), A8C += l1Y[k1Y][s8C], q8C -= e8C[k1Y]) : (l1Y[f2Z.t3C(273)](k1Y, 1), e8C[f2Z.t3C(273)](k1Y, 1), k1Y -= 1);
                    C8Z = f2Z.n2Z()[41][31][7];
                    break;
    ...
    return userresponse_imitator(distance, challenge);
})